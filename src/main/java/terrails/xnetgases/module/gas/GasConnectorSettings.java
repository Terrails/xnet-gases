...
public class GasConnectorSettings extends ChemicalConnectorSettings<GasStack> {
    ...
    public Integer getRate() {
        return rate == null ? GasChannelModule.maxGasRateNormal.get() : rate;
    }
    ...
    public void createGui(IEditorGui gui) {
        ...
        if (advanced) {
            ...
            maxRate = GasChannelModule.maxGasRateAdvanced.get();
        } else {
            speeds = new String[] { "20", "60", "100", "200" };
            maxRate = GasChannelModule.maxGasRateNormal.get();
        }
    ...
    public JsonObject writeToJson() {
        ...
        setEnumSafe(object, TAG_MODE, gasMode);
        ...
        if (rate != null && rate > GasChannelModule.maxGasRateNormal.get()) {
    ...
    public void readFromJson(JsonObject object) {
        ...
        if (object.has("gasmode")) {
            gasMode = getEnumSafe(object, "gasmode", GasUtils::getConnectorModeFrom);
        } else gasMode = getEnumSafe(object, TAG_MODE, GasUtils::getConnectorModeFrom);
    ...
    public void readFromNBT(CompoundNBT tag) {
        ...
        if (tag.contains("gasMode")) {
            gasMode = GasMode.values()[tag.getByte("gasMode")];
        } else gasMode = GasMode.values()[tag.getByte(TAG_MODE)];
    ...
    public void writeToNBT(CompoundNBT tag) {
        ...
        tag.putByte(TAG_MODE, (byte) gasMode.ordinal());
